...
var triviaQuestions = {
    ...
    questionOne: {
        ...
        possibleAnswers: {
            optionOne: {
                option: "AHHHHHHHHHHHHH!!!!!", // #buttonOne .text
                value: true // if questionOne.possibleAnswers.value = true then display win screen, else display lose screen
            },
            optionTwo: {
                option: "Hump Dayyy!!", //#buttonTwo .text
                value: false // false is given to the options that are not true.
            },

            optionThree: {
                option: "Middle of the Week Sneak Peek", //#button three .text
                value: false
            },
            optionFour: {
                option: "Only 234.543598 days until Halloween", // button four . text
                value: false,
                isCorrect: function(){
                    if (this.value){
                        console.log("works");
    ...
    questionTwo: {
        ...
        possibleAnswers: {
            ...
            optionTwo: {
                option: "Hurricane Tor-Tilla!",
                value: true,
            },
            optionThree: {
                option: "Look at all those chickens",
                value: false,
            },
            optionFour: {
                option: "It's Hump Daaayyyy",
                value: false,
            },
    ...
    questionThree: {
        ...
        possibleAnswers: {
            ...
            optionTwo: {
                option: "You're quite the guy",
                value: false,
            },
            optionThree: {
                option: "He half squats down and points with both index fingers, exclaiming 'You're breathtaking!' ",
                value: true,
            },
            optionFour: {
                option: "Amazing personality bro",
                value: false,
            },
        },
...
console.log(triviaQuestions.questionOne.possibleAnswers.optionTwo.option);
console.log(triviaQuestions.questionOne.possibleAnswers.optionOne.option);
//set questionDiv to the question text
$("#questionDiv").text(triviaQuestions.questionOne.text);
...
$("#buttonOne").text(triviaQuestions.questionOne.possibleAnswers.optionOne.option);
$("#buttonTwo").text(triviaQuestions.questionOne.possibleAnswers.optionTwo.option);
$("#buttonThree").text(triviaQuestions.questionOne.possibleAnswers.optionThree.text);
$("#buttonFour").text(triviaQuestions.questionOne.possibleAnswers.optionFour.text);

//set the buttons to read the value for each option to determine if correct or incorrect answer. true = correct, false = incorrect
